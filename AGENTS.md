...
- **下一步（2026-07-24 修订）— 单卡+现有 drafter 下，引擎/高 k 路线已穷尽**:
  1. ✅ **MTP k≥4 崩溃修复**（vLLM 侧，无吞吐收益）: FLASH_ATTN FULL cudagraph 让 k=4/5 稳跑，但须弃 fp8 KV 且 acceptance 衰减仍不赢 k=3。详见 [`docs/benchmark-flashattn-k4-k5-analysis.md`](docs/benchmark-flashattn-k4-k5-analysis.md)。
